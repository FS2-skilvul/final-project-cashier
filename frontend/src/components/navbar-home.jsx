	...
	return (
		<>
			<header className="fixed flex md:justify-center w-full p-4 px-0 md:px-8 lg:px-12 xl:px-16 bg-white shadow top-0 items-center text-xl z-10">
				...
				<div className="font-bold items-center justify-between lg:justify-between md:flex flex mx-6 w-full">
					<div className="flex items-center gap-4">
						...
						<div className="lg:mx-24 md:gap-6 text-isPasif hidden md:flex">
							<Link to="/user-dashboard">
								<button
					...
					<div className="hidden gap-2 font-semibold text-base items-center justify-end text-primary ml-8 lg:ml-0 md:flex ">
						<img
							src="https://c.pxhere.com/images/0d/18/4fa31701d2cfa087836d807967f3-1447663.jpg!d"
							alt=""
							className="border rounded-full w-10 border-primary"
