        ...
        <div className="relative w-full h-auto bg-[#F2F4F9] pt-20 pb-12">
            ...
            <div className="flex flex-col w-full items-center space-y-10">
                ...
                <div className='flex w-[1200px] justify-around'>
                    <div className='w-[300px] bg-white px-9 py-4 space-y-6 text-gray-500 rounded-lg shadow-2xl shadow-gray-300'>
                        <div className='flex w-full items-center justify-between'>
                            <p className='text-5xl font-semibold text-primary'>{total_barang ? total_barang : 0}</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 48 48"><g fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="4"><path d="M44 14L24 4L4 14v20l20 10l20-10z" /><path strokeLinecap="round" d="m4 14l20 10m0 20V24m20-10L24 24M34 9L14 19" /></g></svg>
                        </div>
                    ...
                    <div className='w-[300px] bg-white px-9 py-4 space-y-6 text-gray-500 rounded-lg shadow-2xl shadow-gray-300'>
                        <div className='flex w-full items-center justify-between'>
                            <p className='text-5xl font-semibold text-primary'>{transactions ? transactions.length : 0}</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24"><path fill="currentColor" d="M17 18a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2c0-1.11.89-2 2-2M1 2h3.27l.94 2H20a1 1 0 0 1 1 1c0 .17-.05.34-.12.5l-3.58 6.47c-.34.61-1 1.03-1.75 1.03H8.1l-.9 1.63l-.03.12a.25.25 0 0 0 .25.25H19v2H7a2 2 0 0 1-2-2c0-.35.09-.68.24-.96l1.36-2.45L3 4H1zm6 16a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2c0-1.11.89-2 2-2m9-7l2.78-5H6.14l2.36 5z" /></svg>
                        </div>
                ...
                <div className='w-[1200px]'>
                    <div className='flex items-center space-x-6 text-white bg-[#EA0000] px-9 py-2 rounded-t-lg'>
                    ...
                    {filteredProducts.length > 0 ?
                        filteredProducts.map(product => (
                            <div key={product.id} className='flex items-center justify-between bg-white px-9 py-3 text-xl font-semibold text-gray-700 border-x-2 border-b-2 border-gray-400'>
                                <p>{product.nama}</p>
                                <p>{product.stok} <span>pcs</span></p>
                            </div>
                        ))
                        :
                        <div className='flex items-center justify-between bg-white px-9 py-3 text-xl font-semibold text-gray-700 border-x-2 border-b-2 border-gray-400'>
